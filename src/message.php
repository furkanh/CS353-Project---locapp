...
<html>
  ...
  <?php
    ...
    if(isset($_POST['chatUsername'])){
      $chatUser = new User($_POST['chatUsername']);
      $chatUsername = $chatUser->getUsername();
      echo "<body onload='setMessageBox(\"$username\", \"$chatUsername\");'>";
    }
    else{
...
<?php
  $username = $user->getUsername();
  //echo "<div class='jumbotron' onload='setMessageBox(\"hello hahaha\");'>";
?>
<div class="container">
<div class="jumbotron" >
  <div class="row">
    <?php echo $chatUser->getUsername(); ?>
  </div>
  <div class="row">
    <textarea id="messageBox" rows="10" disabled="true" cols="200"></textarea>
  </div>

  <div class="row">
    <textarea rows="1" cols="141" id="messageArea"></textarea>
    <button class="btn btn-primary" onclick='sendMessage("<?php echo $user->getUsername(); ?>", "<?php echo $chatUser->getUsername(); ?>");'>Send</button>
  </div>
</div>
</div>
<!-- content here -->
